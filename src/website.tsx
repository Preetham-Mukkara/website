...
const SKILLS: SkillGroup[] = [
  {
    category: "Languages",
    items: ["Kotlin", "Rust", "Java", "Go", "TypeScript", "SQL", "JavaScript", "Python"],
  },
  {
    category: "Frameworks",
    items: ["Micronaut", "Axum", "Kafka Streams", "React", "Node.js", "Ktor", "Quarkus"],
  },
  {
    category: "Infra & Tools",
    items: ["Kubernetes", "Docker", "Helm", "Istio", "AWS", "Gradle", "Skaffold", "Nginx"],
  },
];
...
export default function Portfolio() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    e.preventDefault();
    try {
      const res = await fetch("https://formspree.io/f/maqpokaj", {
        method: "POST",
  ...
  return (
    ...
    >
        ...
        >
          <div style={{ flex: 1, minWidth: 280 }}>
            ...
            <h1
              className="a1"
              style={{
                fontSize: "clamp(48px,8.5vw,90px)",
                fontWeight: 400,
                lineHeight: 1.0,
            ...
            >
              Preetham
              <br />
              Mukkara<span style={{ color: T.accent }}>.</span>
            </h1>
            <p
              className="a3 mono"
              style={{
            ...
            >
              Hi there! I'm Preetham, a software engineer who works on distributed systems, spends
              weekends on PNW trails, and has been emotionally invested in the Minnesota Vikings for
              longer than is medically advisable. Currently in Seattle, always in search of a good
              cup of coffee.
            </p>
            <div
              className="a4"
            ...
            >
              <button className="btn-p" onClick={() => scrollTo("experience")}>
                View Experience
              </button>
              <a href="/resume.pdf" download="Preetham Mukkara Resume.pdf" className="btn-p">
                Resume
              </a>
              <button
                className="larrow"
      ...
      <section
        id="education"
        style={{ padding: "80px clamp(24px,6vw,80px)", maxWidth: 1000, margin: "0 auto" }}
      >
        <FadeIn>
            ...
            <FadeIn key={e.school} delay={i * 0.12}>
              <div className="edu-card">
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p className="mono" style={{ fontSize: 13, color: T.bodyMuted, marginTop: 6 }}>
                    {e.degree}
                  </p>
                  {e.note && (
                    <p
          ...
          {EXPERIENCE.map((job: ExperienceEntry, i: number) => (
            <FadeIn key={job.company} delay={i * 0.1}>
              <div className="job-card-compact">
                ...
                <p
                  className="mono"
                  style={{ fontSize: 12, lineHeight: 1.75, color: T.bodyMuted, marginBottom: 16 }}
                >
                  {job.summary}
                </p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {job.tags.map((tag: string) => (
                    <span key={tag} className="xtag">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <section
        id="contact"
        style={{ padding: "80px clamp(24px,6vw,80px) 180px", maxWidth: 1000, margin: "0 auto" }}
      >
        <FadeIn>
        ...
        {sent ? (
          <FadeIn>
            {error ? (
              <p className="mono" style={{ fontSize: 12, color: "#e05555", marginTop: 12 }}>
                Something went wrong — try emailing me directly at mukkarapreetham@gmail.com
              </p>
            ) : (
              <div
                className="mono"
          ...
          <FadeIn delay={0.3}>
            <form
              ...
              style={{ maxWidth: 460, display: "flex", flexDirection: "column", gap: 30 }}
            >
              <input
                type="text"
